...
public class indiv_seq_position_probes {
    private static ArrayList<mt_var.probes.seq_probe> sp;
    private static ArrayList<mt_var.probes.seq_probe> pfinal;
    private static mt_var.probes.seq_probe ptemp;
...
//    private static FileWriter fw;
    ...
    public static void main(String args[]) {
        String r = create_probes("'EU092740'");
                //"'DQ112735'");
     ...
     public static  String create_probes(String seq) 
    {
       ...
       sp = new ArrayList<mt_var.probes.seq_probe>();
       
       //retained rows with computed test pprobe
        pfinal = new ArrayList<mt_var.probes.seq_probe>();
       ...
       {
           String cs[] = c[i].split(",");
           mt_var.probes.seq_probe p = new mt_var.probes.seq_probe();
...
//                        dmp.diffCleanupSemantic(diffs);
           ...
           { //blank test_probe; find flanking ref_probes
               if(flank_found.compareTo(false)==0)
               {
                   ...
                   try
                   {
                   ptemp = new mt_var.probes.seq_probe();
...
//                          return "";
     ...
     private static void fix_last_probe(String seq, String[] c)
             {
                 mt_var.probes.seq_probe p2 = new mt_var.probes.seq_probe();
